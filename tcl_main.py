...
parser.add_argument("--policy_freq", default=4, type=int, help='Frequency of delayed policy updates')
parser.add_argument('--hidden_sizes', nargs='+', type=int, default = [300, 300], help = 'indicates hidden size actor/critic')

# General params
parser.add_argument('--env_name', type=str, default='metaworld-ml1-push-v1')
...
parser.add_argument('--num_initial_steps',  type=int, default = 1500)
...
parser.add_argument('--lam_csc', default=0.05, type=float, help='logisitc regression reg, smaller means stronger reg')
...
if __name__ == "__main__":
    ...
    if args.enable_promp_envs == True:
        ...
        print("@@@@@@@@@ Using Metaworld ML1 Envs @@@@@@@@@")
    print('----------------------------')
