...
@register_env('metaworld-ml1-button-press-v1')
class MetaworldML1ButtonPressEnv(metaworld.ML1):
    def __init__(self, n_tasks=50, randomize_tasks=True):
        super(MetaworldML1ButtonPressEnv, self).__init__('button-press-v1')
        self._env = self.train_classes['button-press-v1']()
