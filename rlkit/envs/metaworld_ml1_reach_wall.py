...
@register_env('metaworld-ml1-reach-wall-v1')
class MetaworldML1ReachWallEnv(metaworld.ML1):
    def __init__(self, n_tasks=50, randomize_tasks=True):
        super(MetaworldML1ReachWallEnv, self).__init__('reach-wall-v1')
        self._env = self.train_classes['reach-wall-v1']()
