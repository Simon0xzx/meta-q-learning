...
@register_env('metaworld-ml1-sweep-into-v1')
class MetaworldML1SweepIntoEnv(metaworld.ML1):
    def __init__(self, n_tasks=50, randomize_tasks=True):
        super(MetaworldML1SweepIntoEnv, self).__init__('sweep-into-v1')
        self._env = self.train_classes['sweep-into-v1']()
