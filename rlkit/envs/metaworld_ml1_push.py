...
@register_env('metaworld-ml1-push-v1')
class MetaworldML1PushEnv(metaworld.ML1):
    def __init__(self, n_tasks=50, randomize_tasks=True):
        super(MetaworldML1PushEnv, self).__init__('push-v1')
        self._env = self.train_classes['push-v1']()
