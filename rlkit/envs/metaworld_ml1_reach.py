...
@register_env('metaworld-ml1-reach-v1')
class MetaworldML1ReachEnv(metaworld.ML1):
    def __init__(self, n_tasks=50, randomize_tasks=True):
        super(MetaworldML1ReachEnv, self).__init__('reach-v1')
        self._env = self.train_classes['reach-v1']()
